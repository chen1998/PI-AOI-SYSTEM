// static/js/bpi_density/multidd2.js
// 多選下拉元件（checkbox + 搜尋 + 全選/清空 單一切換鈕）— bpi_density 版
(function () {
  ...
  class MultiDD {
    ...
    updateOptions(options = []) {
      ...
      if (this.nodes.select) {
        this._fillSelect(this.nodes.select, this.options, this.selected);
      }
      if (this.nodes.rebuildList) this.nodes.rebuildList();
